...
def train(
    ...
    model = acLSTM(
        in_frame_size=in_frame, hidden_size=hidden_size, out_frame_size=out_frame
    )
...
def main():
    ...
    parser.add_argument(
        "--hidden_size", type=int, default=1024, help="Checkpoint model path"
    )
    parser.add_argument(
        "--seq_len", type=int, default=100, help="Checkpoint model path"
    )
    parser.add_argument(
        "--total_iterations", type=int, default=100000, help="Checkpoint model path"
    )
